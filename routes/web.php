...
Route::put('caja/update', [CajaController::class, 'update'])->name('caja.update');
...
Route::get('ingrediente/create', [IngredienteController::class, 'create'])->name('compra.create');
Route::post('ingrediente/store', [IngredienteController::class, 'store'])->name('compra.store');
Route::get('ingrediente/{id}/edit', [IngredienteController::class, 'edit'])->name('ingrediente.edit');
Route::put('ingrediente/update', [IngredienteController::class, 'update'])->name('ingrediente.update');
...
Route::put('mesa/update', [MesaController::class, 'update'])->name('mesa.update');
...
Route::put('pedido/update', [PedidoController::class, 'update'])->name('pedido.update');
...
Route::put('plato/update', [PlatoController::class, 'update'])->name('plato.update');
...
Route::put('reserva/update', [ReservaController::class, 'update'])->name('reserva.update');
...
Route::put('rol/update', [RolController::class, 'update'])->name('rol.update');
